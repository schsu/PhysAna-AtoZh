...
c     &        ivalue(n),value(n),name(n)
 ...
 99    continue      
       ...
       bn="mgyukawa"
       call set_it(n,ivalue,value,name,3,bn,msMS,0.1d0)
       ...
       call set_it(n,ivalue,value,name,13,bn,mmuMS,0.1d0)
       call set_it(n,ivalue,value,name,15,bn,mtaMS,1.777d0)
       bn="mgckm"
       call set_it(n,ivalue,value,name,1,bn,vud,1d0)
       bn="mass"
       call set_it(n,ivalue,value,name,3,bn,smass,0.1d0)
       ...
       call set_it(n,ivalue,value,name,13,bn,mmass,0.1d0)
       ...
       call set_it(n,ivalue,value,name,25,bn,mh1,100d0)
       call set_it(n,ivalue,value,name,35,bn,mh2,100d0)
       call set_it(n,ivalue,value,name,36,bn,mh3,100d0)
       call set_it(n,ivalue,value,name,37,bn,mhc,100d0)
       bn="decay"
       ...
       call set_it(n,ivalue,value,name,25,bn,wh1,1d0)
       call set_it(n,ivalue,value,name,35,bn,wh2,1d0)
       call set_it(n,ivalue,value,name,36,bn,wh3,1d0)
       call set_it(n,ivalue,value,name,37,bn,whc,1d0)
       bn='mguser'
       call set_it(n,ivalue,value,name,1,bn,tanbeta ,0d0)
       call set_it(n,ivalue,value,name,2,bn,sinalpha ,0d0)
       call set_it(n,ivalue,value,name,3,bn,singamma ,0d0)
      return
      end
